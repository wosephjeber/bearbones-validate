...
Form validations can be set up with: `variable = new FormValidator(formObject, options);` where `formObject` is a DOM or jQuery object and `options` is an object. More details on the options below.
